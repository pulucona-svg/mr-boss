...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
            ...
            Expanded(
              child: ListView(
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(child: _buildEditField('Year', yearController, isDark)),
                      const SizedBox(width: 12),
                      Expanded(child: _buildEditField('Semester', semController, isDark)),
                    ],
                  ),
                  _buildEditField('Phone Number', phoneController, isDark, keyboardType: TextInputType.phone),
                  _buildEditField('Email Address', emailController, isDark, keyboardType: TextInputType.emailAddress),
  ...
  Widget _buildEditField(String label, TextEditingController controller, bool isDark, {TextInputType? keyboardType}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
